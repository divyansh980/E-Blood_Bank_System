          ...
          <div class="col-md-4 w3l-footer">
            <h2 class="mb-sm-3 mb-2">
              <a href="index.php" class="text-white font-italic font-weight-bold">
                <span>E-Blood </span>Bank Management System 
                <i class="fas fa-syringe ml-2"></i>
              </a>
            </h2>
            <p>This project aims to improve the accessibility and efficiency of blood donations, making it easier for both donors 
              and recipients to contribute to life-saving efforts. With real-time updates and seamless user interaction, it fosters 
              a reliable and organized network of blood banks and donors.</p>
          </div>
...
{ ?>
        ...
        <div class="border-top mt-5 pt-lg-4 pt-3 pb-lg-0 pb-3 text-center">
          <p class="copy-right-grids mt-lg-1">Divyansh 2024 © E-Blood Bank & Donor Management System
